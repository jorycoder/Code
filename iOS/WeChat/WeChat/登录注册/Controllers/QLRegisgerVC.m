...
- (IBAction)registerBtnClick {
    ...
    // 2.调用QLXMPPTool的xmppUserRegister

    [QLXMPPTool sharedQLXMPPTool].registerOperation = YES;
    
    // 提示
    [MBProgressHUD showMessage:@"正在注册中....." toView:self.view];
    
    __weak typeof(self) selfVc = self;
    [[QLXMPPTool sharedQLXMPPTool] xmppUserRegister:^(XMPPResultType type) {
